public class L22_String_Methods {
    public static void main(String[] args) {
        ...
        // System.out.println(name.substring(2)); // Returns a substring of the string
        // System.out.println(name.substring(1, 3)); // Returns a substring of the string
        ...
        System.out.println(name.equals("John")); // Compares the string to the specified string
        // System.out.println(name.equalsIgnoreCase("john")); // Compares the string to the specified string ignoring case considerations
